...
class SistemaCRM: # criando outra classe 
    ...
    def listar_registros(self):
        self.cursor.execute("SELECT nome_cliente,telefone,ultima_compra FROM clientes") #está chamando  a variável cursor e está sendo acompanhada do comando pra executar o comando sql que está em forma de string
        ...
        for registro in registros : # fazer abusca de registro através da variável registros
            print(f"nome :{registro[0]} telefone: {registro[1]} data da ultima compra: {registro[2]}") # aqui é como se o registro estivesse recebendo os indicies de cada coluna da tabela matricula
